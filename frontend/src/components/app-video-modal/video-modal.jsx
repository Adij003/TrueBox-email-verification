...
function AppModalVideoView({
  ...
  const imageSrc=`${CONFIG.site.basePath}/assets/images/${getHelp===false?'big-card-thumbhnails/app':'get-help-video-thumbnails/app'}/${thumbnailName}`
...
export default memo(AppModalVideoView);
