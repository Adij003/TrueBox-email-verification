...
function AdminModalVideoView({
  ...
  const imageSrc=`${CONFIG.site.basePath}/assets/images/${getHelp===false?'big-card-thumbhnails/admin':'get-help-video-thumbnails/admin'}/${thumbnailName}`
  ...
  return (
    <Box style={{ position: 'relative', display: 'inline-block', width: '100%' }}>
      ...
      <Dialog
        ...
        maxWidth="lg"
        fullWidth
        sx={{ '& .MuiDialog-paper': { width: 1060, height: { xs: 224,sm: 400, md: 600 } } }}
      >
        <IconButton
          onClick={handleClose}
...
export default memo(AdminModalVideoView);
